...
parser.add_argument('-csvPath', required=False, default='Warsaw_1-fold_test_train_split_new.csv', type=str)
parser.add_argument('-datasetPath', required=False, default='Z:/1st/Iris_dataset/Warsaw_labeling_iris_data/innerclass/Proposed/1-fold', type=str)
parser.add_argument('-outputPath', required=False, default='Z:/2nd_paper/backup/Compare/Detectors/temp/Ablation/DNet/1-fold_5/', type=str)
...
for epoch in range(args.nEpochs):
    ...
    for phase in ['train', 'test']:
        ...
        if phase == 'train':
            ...
            save_best_model = os.path.join(log_path, args.method + f'_{epoch+1}.pth')
            states = {
                'epoch': epoch + 1,
...
errorIndex, predictScore, threshold = obvResult.get_result(args.method, testImgNames, testTrueLabels, testPredScores,
                                                           result_path)
